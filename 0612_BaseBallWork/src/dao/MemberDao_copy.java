...
;		}		
	...
	public void loadData() {
		...
		for(int i =0; i<datas.size(); i++) {
			...
			if(title<2000) {
				HumanList.add(new Pitcher(Integer.parseInt(data[0]),
										data[1],
				...
				HumanList.add(new Batter(Integer.parseInt(data[0]),data[1],Integer.parseInt(data[2]),Double.parseDouble(data[3]),Integer.parseInt(data[4]),
										Integer.parseInt(data[5]),
										Double.parseDouble(data[6])));
			}
		}
